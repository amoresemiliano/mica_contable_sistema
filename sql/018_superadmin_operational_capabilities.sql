...
-- and administrative RPCs while strictly maintaining canonical RPC bodies:
-- - Rebuilt directly from canonical pre-M018 RPC definitions
-- - Changes ONLY authorization predicates to include SUPERADMIN
-- - Preserves 100% of validation rules, deduplication, retry semantics,
--   fiscal fingerprints, and data transformations.
-- ============================================================
