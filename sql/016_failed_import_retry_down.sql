-- Migration 016 Down: Rollback failed import retry support and restore exact pre-016 contracts
BEGIN;

-- 1. Drop Migration 016 added objects
...
-- 2. Restore exact pre-016 definition of persist_financial_movements_batch from Migration 013.3
    ...
    IF NOT v_is_invalid THEN
      BEGIN
        ...
        ELSIF v_import_record.source_type = 'BANK_STATEMENT_BBVA' THEN
          -- 013.3 FECHAS BBVA ESTRICTAS (SOPORTE DD-MM-YYYY)
