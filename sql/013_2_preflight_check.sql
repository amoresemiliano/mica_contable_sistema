-- Preflight Check for Migration 013.2
DO $$
BEGIN
  ...
  IF NOT EXISTS (
    ...
    RAISE EXCEPTION 'Preflight failed: table public.eco_financial_movements does not exist';
  END IF;
  ...
  RAISE NOTICE 'Preflight check passed: Migration 013.2 can be safely applied.';
END $$;
