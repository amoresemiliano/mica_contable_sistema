-- ============================================================
-- MIGRATION 027: FIX BBVA IMPORT, RETRY LINEAGE JOIN & DIAGNOSTICS
-- ============================================================
-- 1. Updates check_file_importable to ensure imports with 0 accepted rows
--    do NOT permanently block file re-upload/retry.
-- 2. Updates request_failed_import_retry to fix join on eco_normalized_records
--    via row_id -> eco_import_rows -> eco_source_files -> eco_source_imports.
-- 3. Updates persist_financial_movements_batch to log descriptive error reasons
--    in eco_import_issues for invalid rows.
-- ============================================================
...
BEGIN
  ...
  -- Block file re-upload ONLY IF a previous import produced a successful business result (accepted_rows > 0)
...
-- 2. UPDATE request_failed_import_retry
...
-- 3. UPDATE persist_financial_movements_batch
