-- ============================================================
-- MIGRATION 026: WP-FUNC-3 BANK STATEMENT NORMALIZATION & RETRY CONSISTENCY
-- ============================================================
-- 1. Updates check_file_importable so imports with 0 accepted business rows
--    do NOT permanently block file re-upload.
-- 2. Updates persist_financial_movements_batch to:
--    - align SHA256 duplicate checks with check_file_importable (COALESCE(accepted_rows,0) > 0);
--    - populate row_id into eco_financial_movements from eco_import_rows;
--    - support fallback identity generation when both referencia and saldo are absent.
-- ============================================================
