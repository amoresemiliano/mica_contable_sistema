-- ============================================================
-- DB PERFORMANCE BENCHMARK — PATTERN C: SET-BASED JOIN
-- WP-A3.2.0 (Migration 021 Validation)
-- ============================================================
-- Evaluates query plan shape and buffer usage for set-based JOIN.
...
BEGIN
  ...
  INSERT INTO auth.users (
    ...
    'authenticated',
    'authenticated',
    'bench_user_c_' || v_synth_auth_id::text || '@mica.test',
  ...
  RAISE NOTICE 'Benchmark fixture initialized: 10,000 synthetic records created for Pattern C.';
END $$;

-- ============================================================
-- EXPLAIN ANALYZE — PATTERN C: Set-Based Join
-- ============================================================
