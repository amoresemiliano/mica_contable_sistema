-- ============================================================
-- DB PERFORMANCE BENCHMARK — PATTERN B: SET-BASED IN SUBQUERY
-- WP-A3.2.0 (Migration 021 Validation)
-- ============================================================
-- Evaluates query plan shape and buffer usage for set-based IN predicate.
...
BEGIN
  ...
  INSERT INTO auth.users (
    ...
    'authenticated',
    'authenticated',
    'bench_user_b_' || v_synth_auth_id::text || '@mica.test',
  ...
  RAISE NOTICE 'Benchmark fixture initialized: 10,000 synthetic records created for Pattern B.';
END $$;

-- ============================================================
-- EXPLAIN ANALYZE — PATTERN B: Set-Based IN Subquery
-- ============================================================
